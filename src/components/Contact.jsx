...
const socialLinks = [
  {
    href: "https://www.github.com/mukeshlilawat1",
    icon: (
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form action="https://getform.io/f/awnyyxzb" method="POST" className="xl:pl-10 2xl:pl-20 ">
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="lilawat@example.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="HI!"
              required
              className="text-field rezsize-y min-h-32 max-h-80 reveal-up"
            ></textarea>
          </div>
